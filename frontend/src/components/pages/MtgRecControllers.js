...
import botServiceHealth from "../../assets/botServiceHealth.svg";
   ...
   function MtgRecControllers() {
    ...
    const handlePost = () => {
      handleApiRequest("join");
    };
  
    const handleLeave = () => {
      handleApiRequest("leave");
    };
      ...
      <>
        ...
        <div className="mtg-bot-container">
          <div className="mtg-bot-status">
            <div>
              <p className="txt">
                ...
                Meeting Bot is a Zoom App that can be used to record meetings and transcribe them in real time. <br />
                Meeting Bot: Not Active, click the bot to activate invite bot.
              </p>
            </div>
          </div>
          <hr/>
          <div className="mtg-rec-controllers">
            ...
            <button className="mtg-btn" onClick={handleLeave}>
